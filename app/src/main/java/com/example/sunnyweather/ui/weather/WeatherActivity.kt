...
class WeatherActivity : AppCompatActivity() {
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        val ultralightText: TextView = findViewById(R.id.ultravioletText)
        val carWarningsText: TextView = findViewById(R.id.carWashingText)
        val weatherLayout: ScrollView = findViewById(R.id.weatherLayout)

        val lifeIndex = daily.lifeIndex
        coldRiskText.text = lifeIndex.coldRisk[0].desc
        dressingText.text = lifeIndex.dressing[0].desc
        ultralightText.text = lifeIndex.ultraviolet[0].desc
        carWarningsText.text = lifeIndex.carWashing[0].desc
